...
- **GPU-Beschleunigung** - verwendet Ihre Grafikkarte für schnellere Videokodierung. Unterstützt NVIDIA (NVENC), AMD (AMF), Intel (QuickSync) und Apple (VideoToolbox). Kann 3-5x schneller sein als CPU-Kodierung. Wenn keine kompatible GPU erkannt wird, ist die Option deaktiviert.
