...
- **Accelerazione GPU** - usa la scheda grafica per una codifica video più veloce. Supporta NVIDIA (NVENC), AMD (AMF), Intel (QuickSync) e Apple (VideoToolbox). Può essere 3-5 volte più veloce della codifica CPU. Se non viene rilevata una GPU compatibile, l'opzione sarà disabilitata.
