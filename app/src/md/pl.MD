...
- **Akceleracja GPU** - używa karty graficznej do szybszego kodowania wideo. Obsługuje NVIDIA (NVENC), AMD (AMF), Intel (QuickSync) i Apple (VideoToolbox). Może być 3-5x szybsza niż kodowanie CPU. Jeśli nie zostanie wykryta kompatybilna karta graficzna, opcja będzie wyłączona.
