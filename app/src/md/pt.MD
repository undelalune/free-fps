...
- **Aceleração por GPU** - usa a placa gráfica para codificação de vídeo mais rápida. Suporta NVIDIA (NVENC), AMD (AMF), Intel (QuickSync) e Apple (VideoToolbox). Pode ser 3-5x mais rápida que a codificação por CPU. Se nenhuma GPU compatível for detetada, a opção será desativada.
